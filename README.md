...
В результате выполнения лабораторной работы, я узнал как использовать машинное обучение в Unity. Также получил опыт подключения библиотек и взаимодействий с ML Agent'ом с помощью Anaconda prompt и интерфейса командной строки.
